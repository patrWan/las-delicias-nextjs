    ...
    <>
      <div className='bg-zinc-800 shadow-lg w-full flex flex-col p-2 h-auto rounded-md'>
        <div className='h-12 flex justify-between items-center'>
          <p className='text-lg font-bold text-teal-400'>Ventas de hoy</p>
          <button className='border-2 border-teal-800/20 p-2 cursor-pointer text-teal-400 hover:text-teal-200'>Exportar</button>
        </div>
